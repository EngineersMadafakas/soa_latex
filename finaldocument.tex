...
The music and sounds provided by the application have a good quality overall. There is a mix of bare nature sounds and oriental music or monk chanting. Some combinations of sounds are provided for the user to try in the favourites list, like \it{Relaxing Day} or \it{Dawn in the Forest}.

\subsubsection{Analysis of business model and strategy}

The application is offered for free with limited content. The full version (or Premium as the developer named it) costs \euro{2,69}. The strategy in this case is make the application well known with the free version, and showcase to every user what they are missing by not using the premium version. With so many free downloads (almost 2 million for iOS), even a small conversion rate can turn great profits. 
