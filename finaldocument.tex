...
\begin{figure}[H]
\centering
\includegraphics[width=0.24\textwidth]{figures/AEON_Intro_01.png}
\includegraphics[width=0.24\textwidth]{figures/AEON_Intro_02.png}
\includegraphics[width=0.24\textwidth]{figures/AEON_Intro_Quest_01.png}
\includegraphics[width=0.24\textwidth]{figures/AEON_Intro_Quest_02.png}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.24\textwidth]{figures/AEON_Mind_Quest_01.png}
\includegraphics[width=0.24\textwidth]{figures/AEON_Mind_Quest_02.png}
\includegraphics[width=0.24\textwidth]{figures/AEON_Mind_Quest_03.png}
\includegraphics[width=0.24\textwidth]{figures/AEON_Mind_Quest_04.png}
\includegraphics[width=0.24\textwidth]{figures/AEON_Mind_Quest_05.png}
\includegraphics[width=0.24\textwidth]{figures/AEON_Mind_Quest_06.png}
...
\subsubsection{Users' feedback}
The Android version of this app has been rated 3.7 stars over 5. No text opinions are available at the Google Play Store. 
...
\item Speaker icon button: this button allows the user to change the soundo options:
\begin{itemize}
...
Each time a meditation is acomplished, a progress bar is increased; and each time a progress bar is fulfilled, the user meditation level is increased, and so is the meditation time. This level increase can be seen at the right most screenshot of figure \ref{fig:BMT_MainAndMed}.
...
\subsubsection{Analysis of business model and strategy}
The Android version of this app is free to download and has no in-app purchases; so, it is not bussiness-oriented and the authors intend to make no profit with it.
