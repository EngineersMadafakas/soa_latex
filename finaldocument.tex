...
\begin{tabular}{|l|l|}
\hline
Team members: 	& Miguel Cabrera García, \textit{Telecommunications Engineer}.\\
				& Pablo Gijón, \textit{Clinical Psychologist}.\\
				& Alberto Olivares Ph.D., \textit{Telecommunications Engineer}.\\
			  	& Pablo Rubio Sánchez, \textit{Software Engineer}.\\
			  	& Gonzalo Ruiz García, \textit{Telecommunications Engineer}. \\\hline
\end{tabular}
}
\end{center}
\vspace{0.7cm}
...
\begin{itemize}
\item \textit{Welcome:} This section plays a welcome message of a few minutes of duration.
...
\item \textbf{Reminders Section:} The user can set reminders to start a meditation or to pop up mindfulness notes. 
...
\item Suggestions of use: This section includes a short text with several advices and indications for new meditators on how to use the app.
\item Mindfulness Courses: A text publicizing serveral mindfulness courses taught in the University of Massachussetts. 
\item About Mindfulness: A short text describing what mindfulness is and what possitive effects its practice may lead to practitioners.
\item About Mindapps: This section contains information about the company which has developed the app.
\item Informed consent: legal agreement to use the app.
\item Share: button to share the app through different channels, such as e-mail or social networks.
\end{itemize}
...
This App is, in general, very complete and has high quality content and proper user interface. Meditations are easy to follow, and is appropriate for both newcomers and experienced mindfulness practitioners. 
...
\item \textbf{Content}: Although present meditations are high quality and easy to perform, it would be desirable to have more duration options for both guided and silent meditations: for example, it seems necessary to have a 10 minutes meditation, as the difference between the two other closest options (5 and 15 minutes) seems to be very large. 
\end{itemize}
...
This is, by far, the highest quality app analyzed in this document. User interface, content and number of users/downloads demonstrate the content is very appropriate for both beginners and experienced mindfulness practitioners. Although some of its content and options can be improved and extended, the whole app is a very good reference to develop future software and extended content. 
...
\begin{wrapfigure}{l}{0.08\textwidth}
  ...
  \vspace*{-0.5cm}
\end{wrapfigure}
Mindfulness Focus Now (MFN), is a meditation helper focused on keeping the user from distraction and being aware of the thoughts that do distract him. It is offered by Marcial Arredondo Rosas, part of the "Mindfulness\&Psicología Barcelona" team. Marcial is a Clinical Psychologist currently researching for the UAB about mindfulness training. The application is being used as a tool in his research. \\
...
\item Terms and conditions: legal terms and conditions to use the app.
...
Each time a meditation is acomplished, a progress bar is increased certain amount; and each time a progress bar is fulfilled, the user meditation level is increased, and so is the meditation time. This level increase can be seen at the right most screenshot of figure \ref{fig:BMT_MainAndMed_2}.
...
\caption{Buddhist Meditation Tutorial main screen and several meditation screens (1).}
\label{fig:BMT_MainAndMed_1}
\end{figure}
...
\caption{Buddhist Meditation Tutorial main screen and several meditation screens (2).}
\label{fig:BMT_MainAndMed_2}
\end{figure}
