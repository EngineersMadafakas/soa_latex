...
The music and sounds provided by the application have a good quality overall. There is a mix of bare nature sounds and oriental music or monk chanting. Some combinations of sounds are provided for the user to try in the favourites list, like \it{Relaxing Day} or \it{Dawn in the Forest}. There are also a few binaural rhythms, which are supposed to cause effects on brainwaves when listened through headphones.
